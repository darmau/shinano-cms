...
<div class="dialog" aria-labelledby="modal-title" role="dialog" aria-modal="true">
	...
	<div class="fixed inset-0 z-10 w-screen overflow-y-auto">
		<div class="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
			<div
				class="relative transform overflow-hidden rounded-lg bg-white px-4 pb-4 pt-5 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg md:max-w-3xl sm:p-6"
			>
				<div class="">
					...
					<div class="mt-4 flex flex-col gap-4 md:grid md:grid-cols-3">
						<div>
							<img
								src={`${data.prefix}/cdn-cgi/image/format=auto,width=720/${data.prefix}/${imageData.storage_key}`}
