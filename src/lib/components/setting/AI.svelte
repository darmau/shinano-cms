	...
	>
		...
		<div class="space-y-2">
			<div class="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
				<label for="prompt_slug" class="block text-sm font-medium leading-6 text-gray-900">
					根据标题生成网址末尾的slug
				</label>
				<div class="sm:w-64">
		...
		<div class="space-y-2">
			<div class="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
				<label for="prompt_seo" class="block text-sm font-medium leading-6 text-gray-900">
					生成文章摘要用于SEO
				</label>
				<div class="sm:w-64">
		...
		<div class="space-y-2">
			<div class="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
				<label for="prompt_translation" class="block text-sm font-medium leading-6 text-gray-900">
					翻译内容
				</label>
				<div class="sm:w-64">
		...
		<div>
			<label for="prompt_image_alt" class="block text-sm font-medium leading-6 text-gray-900">
				生成图片的alt属性
			</label>
			<textarea
				id="prompt_image_alt"
		...
		<div class="space-y-2">
			<div class="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
				<label for="prompt_tags" class="block text-sm font-medium leading-6 text-gray-900">
					生成内容的Tags
				</label>
				<div class="sm:w-64">
