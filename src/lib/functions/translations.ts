...
const translations: Translation = {
	'zh-CN': {
		...
		'api-resend': '用于给用户发送被评论通知',
		'api-bark-server': '用于给管理员发送通知',
		'upload-photo': '上传照片',
		'shooting-time': '拍摄时间',
		...
		delete_comment: '删除评论',
		confirm_delete_comment: '确认删除这条评论吗？',
		set_public_success: '成功设为公开',
		block_comment_success: '成功封禁评论',
		unblock_comment_success: '成功解封评论',
	...
	en: {
		...
		'password-requirement':
			'Password must contain uppercase, lowercase, and number, at least 8 characters',
		...
		'language-delete-fail':
			'Failed to delete language, please check if there are still associated contents',
		'url-prefix': 'This field is used for the URL prefix of object storage',
		'api-unsplash':
			'If you want to use Unsplash API to add images to articles, you need to fill in Unsplash API Key here',
		...
		'api-resend': 'Used to send comment notification to users',
		'api-bark-server': 'Used to send notification to administrators',
		...
		'alt-text-description':
			'For accessibility consideration, it is recommended to fill in alt text',
		folder: 'Folder',
		close: 'Close',
		'next-page': 'Next',
		...
		set_public_success: 'Successfully set to public',
		block_comment_success: 'Comment blocked successfully',
		unblock_comment_success: 'Comment unblocked successfully',
	...
	'zh-TW': {
		...
		'api-resend': '用於給用戶發送被評論通知',
		'api-bark-server': '用於給管理員發送通知',
		'upload-photo': '上傳照片',
		'shooting-time': '拍攝時間',
		...
		delete_comment: '刪除評論',
		confirm_delete_comment: '確認刪除這條評論嗎？',
		set_public_success: '成功設為公開',
		block_comment_success: '成功封禁評論',
		unblock_comment_success: '成功解封評論',
	...
	jp: {
		...
		'language-delete-fail':
			'言語の削除に失敗しました。関連コンテンツがまだあるかどうかを確認してください',
		'url-prefix': 'このフィールドはオブジェクトストレージのURLプレフィックスに使用されます',
		'api-unsplash':
			'記事に画像を追加するためにUnsplash APIを使用する場合は、ここにUnsplash APIキーを入力する必要があります',
		'api-amap': '写真が中国で撮影された場合、Amap APIを使用することをお勧めします',
		'api-mapbox': '写真が海外で撮影された場合、Google Map APIを使用することをお勧めします',
		'api-resend': 'ユーザーにコメント通知を送信するために使用されます',
		'api-bark-server': '管理者に通知を送信するために使用されます',
		...
		set_public_success: '公開に設定しました',
		block_comment_success: 'コメントをブロックしました',
		unblock_comment_success: 'コメントのブロックを解除しました',
